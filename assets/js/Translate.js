(function() {
    ...
    var select_language_label = gt.select_language_label || '';
    ...
    el_s.classList.add('gt_selector', 'notranslate','form-control');
    el_s.style.cssText = 'appearance: none; background: var(--latar-belakang); color: var(--teks-utama);width:auto';
